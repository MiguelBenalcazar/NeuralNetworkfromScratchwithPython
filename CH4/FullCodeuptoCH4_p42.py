...
# Create ReLU activation (to be used with Densa Layer)
activation1 = Activation_ReLU()

#Create second Densae Layer with 3 input featurres (as we take output
# of previous layer here) and  3 output values (output values)
dense2 = Layer_Dense(3, 3)

# Create Softmax activaion (to be used with Dense Layer)
...
# it takes the output of activation function of fist layer as inputs
